            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <div class="alert alert-info"><strong>Bulan : <?php echo $bulan; ?>, Tahun : <?php echo $tahun; ?>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            if (mysqli_num_rows($sql) > 0) {
                                ...
                                <a class='btn btn-warning' href='data_kehadiran.php?view=edit$bulan&tahun=$tahun'>Edit Data Kehadiran</a>
                                </td>
                                </tr>";
                            } else {
                                echo "<tr>
                            ...
                            ORDER BY pegawai.nip ASC");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="alpa[]" class="form-control" value="0" required />
                                        </td>
                                        <td>
                                ...
                                ?>
                                    <tr>
                                        <td colspan="10">
                                            <label class="label label-warning">Maaf..,Bulan dan Tahun yang dipilih sudah dirposes,
